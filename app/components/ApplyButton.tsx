...
export default function ApplyButton() {
  ...
  return (
    <>
      <h3 className="inline-flex items-center px-3 py-2 border border-transparent text-lg font-medium rounded-md text-gray-200 bg-red-500 hover:bg-red-700 hover:text-white">
        Application closed
      </h3>
      &nbsp;
      <Link
