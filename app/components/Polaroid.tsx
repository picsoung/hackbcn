...
export default function Polaroid({
  ...
  return (
    <Link
      href={href}
      aria-label={`${label}: view event recap`}
      className={`group relative block bg-white p-2 pb-8 shadow-lg ${width} transition-transform duration-300 ease-out hover:scale-[1.06] hover:!rotate-0 focus-visible:scale-[1.06] focus-visible:!rotate-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-org-accent focus-visible:ring-offset-2 motion-reduce:transition-none motion-reduce:hover:scale-100 motion-reduce:focus-visible:scale-100`}
      style={{
