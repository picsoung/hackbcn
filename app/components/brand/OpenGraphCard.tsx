    ...
    >
      <div
        style={{
          ...
          opacity: 0.18,
          backgroundImage:
            'linear-gradient(#4DE3E8 1px, transparent 1px), linear-gradient(90deg, #4DE3E8 1px, transparent 1px)',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', marginTop: 72 }}>
            ...
            <div
              style={{
                ...
                fontSize: title.length > 28 ? 55 : 64,
                lineHeight: 1.02,
                fontWeight: 900,
            ...
            {details.length > 0 && (
              ...
              >
                {date && (
                  <div style={{ display: 'flex', color: COLORS.ink, fontWeight: 750 }}>
                    <span style={{ color: COLORS.pink, marginRight: 12 }}>■</span>
                    {date}
                  </div>
                )}
                {location && (
                  <div style={{ display: 'flex', color: COLORS.dim, fontWeight: 600 }}>
            ...
            >
              ...
              <div
                style={{
                  ...
                  opacity: 0.17,
                  backgroundImage:
                    'linear-gradient(90deg, transparent 50%, #06060E 50%), linear-gradient(transparent 50%, #06060E 50%)',
